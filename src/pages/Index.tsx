...
const Index = () => {
  ...
  useEffect(() => {
    ...
    const onboarded = localStorage.getItem("fashionos-onboarded");
    const role = localStorage.getItem("fashionos-role");
    // Only kick truly first-time visitors to onboarding.
    if (!onboarded && !role) {
