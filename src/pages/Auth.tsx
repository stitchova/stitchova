          ...
          <motion.div key="form" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} transition={{ duration: 0.3 }} className="flex-1 flex flex-col">
            ...
            <div className="space-y-4 mb-6">
              ...
              {selectedRole === "worker" ? (
                ...
                <>
                  ...
                  {mode === "signin" && (
                    <button className="text-xs text-primary font-medium self-end block ml-auto">Forgot password?</button>
                  )}
                </>
              )}
            </div>
            ...
            <div className="mt-auto space-y-3">
              <motion.button whileTap={{ scale: 0.97 }} onClick={handleSubmit}
                ...
                {selectedRole === "worker" ? "Sign In" : mode === "signin" ? "Sign In" : "Create Account"}
              </motion.button>
